      ...
      <Card className={classes.pointCard}>
        ...
        >
          <Typography className={classes.helpMessage}>
            ...
            <ul style={{ textAlign: "left" }}>
              ...
              <li>
                게시글 작성 시 <b>+5000P</b> 지급
              </li>
              <li>
                댓글 및 답글 작성 시 <b>+5P</b> 지급
              </li>
              <li>
                친구 초대 시 <b>+5000P</b> 지급
              </li>
              <li>
                공유 url을 통해 회원 가입 시 <b>+10000P</b> 지급{" "}
              </li>
              <li>
                계정 연동 시 <b>+100P</b> 지급{" "}
              </li>
            ...
            <Typography color="error">
              <b>
                🙅🏻‍♂️ 작성 게시물, 댓글 삭제 or 연동 계정 해지 시 포인트가 차감될
                수 있습니다!
              </b>
            </Typography>
          </Typography>
        ...
        <CardContent>
          <ul className={classes.pointEvent}>
            <li>
              <PetsIcon fontSize="large" style={{ color: "#795548" }} />
              <p>출석</p>
            </li>
            <li>
              <ShareIcon fontSize="large" style={{ color: "#388e3c" }} />
              <p>친구 초대</p>
            </li>
            <li>
              <CreateIcon fontSize="large" style={{ color: "#5472d3" }} />
              <p>게시물, 댓글</p>
            </li>
            <li>
              <BusinessIcon fontSize="large" style={{ color: "#ff9e80" }} />
              <p>기업 연동</p>
            </li>
          </ul>
        </CardContent>
      ...
      <>
        ...
        {pointList &&
          pointList.map((point, index) => {
            return <PointList key={index} point={point} />;
          })}

        <Button
          disabled={isDisabled}
          style={{ width: "100%" }}
          onClick={handleMorePoint}
        >
          더보기
        </Button>
      </>
