          ...
          {selectedAction && 
               <div style={{display:'flex', flexDirection:"column", alignItems:'baseline'}}>
                    <FormControl style={{marginBottom:'20px'}}>
                         ...
                         <FormHelperText>변경하실 새로운 이벤트 이름을 입력해주세요.</FormHelperText>
                    </FormControl>
                    <FormControl style={{marginBottom:'20px'}}>
                         ...
                         <FormHelperText>변경하실 새로운 포인트 값을 입력해주세요.</FormHelperText>
                    </FormControl>
                    <FormControl style={{marginBottom:'20px'}}>
                         ...
                         <FormHelperText>변경하실 새로운 일일 지급 제한 수를 입력해주세요.</FormHelperText>
                    </FormControl>
               </div>
          }
          <div style={{display:'flex', alignItems:'center', marginTop: '20px'}}>
               <Button color="primary" variant="outlined" onClick={handleSubmit}>저장하기</Button>    
