...
export default function PointCategory(props: CatAdminProps) {
  const { userObj, pointCategory, getPointCategory } = props;
  ...
  const handleAddCategory = () => {
    axios
      .post(
        `${process.env.REACT_APP_SERVER}/api/admin/point/add_point_action`,
        {
          action: newAction,
  ...
  const handleDeletePoint = () => {
    axios
      .post(
        `${process.env.REACT_APP_SERVER}/api/admin/point/delete_point_action`,
        {
