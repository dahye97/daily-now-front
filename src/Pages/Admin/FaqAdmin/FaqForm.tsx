...
export default function FaqForm(props:FaqFormProps) {
     const { userObj,selectedFaq, handleIsUpdated, faqCount } = props;
     ...
     const editUrl = () => {
          ...
          // faq 내용 수정 시
          if ( question !== selectedFaq[0].question || answer !== selectedFaq[0].answer) { 
               data = {
     ...
     const handleSubmit  = (urlQuery:string, data: {}) =>{
          axios.post(`${process.env.REACT_APP_SERVER}/api/admin/faq/${urlQuery}`,
          data,
          {
               headers: {
     ...
     return (
          ...
          <div style={{display:'flex', flexDirection:"column"}}>
               ...
               <FormControl style={{marginBottom:'20px'}}>
                    ...
                    <FormHelperText>변경하실 새로운 질문 내용을 입력해주세요.</FormHelperText>
               </FormControl>
               <FormControl style={{marginBottom:'20px'}}>
                    ...
                    <FormHelperText>변경하실 새로운 답변 내용을 입력해주세요.</FormHelperText>
               </FormControl>
