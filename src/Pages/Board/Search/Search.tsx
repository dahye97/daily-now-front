...
export default function Search(props: searchProps) {
  ...
  const categoryInUrl = queryObj.category;
  const typeInUrl = queryObj.type;
  const keywordInUrl = queryObj.keyword;
    ...
    <Paper className={isMobile ? classes.rootMobile : classes.root}>
      <div className={isMobile ? classes.containerMobile : classes.container}>
        <FormControl className={classes.formControl}>
          ...
          <NativeSelect value={category} onChange={handleChangeCat}>
